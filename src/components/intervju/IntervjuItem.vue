  ...
  <li class="border border-secondary rounded-3 p-3 my-3">
    <div class="row">
      <div class="col-md-3 col-5">
        <router-link :to="'/intervju/details/' + index"><img :src="image" class="w-100 rounded-2 listImg" alt="No Image Provided" /></router-link>
      </div>
      <div class="col-md-7 col-7 d-flex flex-column">
        <h3><router-link :to="'/intervju/details/' + index" class="text-decoration-none text-dark">{{ title }}</router-link></h3>
