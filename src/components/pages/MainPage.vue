  ...
  <div class="bg-pattern">
    ...
    <div class="container">
      <section class="row mt-6 mb-3">
        ...
        >
          <h1>Aktuelno</h1>
          <p class="indented text-justify">{{ aktuelno }}</p>
          <router-link to="/latest" class="mt-auto w-50">
      ...
      <div class="row">
        <div class="col mt-6 mb-5 d-flex justify-content-center">
          <i class="bi bi-chevron-down text-dark fs-1"></i>
        </div>
      </div>
    </div>
